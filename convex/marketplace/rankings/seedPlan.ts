// convex/marketplace/rankings/seedPlan.ts
// single walk of the rankingSeeds manifest.

// previously, planned tasks / ranking counts / seed externalIds / lane
// summaries each took their own iteration — this materializes one plan
// that every consumer reads from.
