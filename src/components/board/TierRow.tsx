...
): CSSProperties
{
  ...
  return {
    position: 'fixed',
    top: Math.min(anchorBottom + POPUP_GAP_PX, Math.max(VIEWPORT_MARGIN_PX, maxTop)),
    left: Math.min(Math.max(anchorLeft, VIEWPORT_MARGIN_PX), Math.max(VIEWPORT_MARGIN_PX, maxLeft)),
  }
}
