        ...
        <>
          ...
          <TextInput
            ...
            {...getInputProps({
              maxLength: 60,
              className:
                'w-full max-w-md border-none px-0 py-0 text-center text-3xl font-semibold tracking-tight focus-visible:ring-2 focus-visible:ring-[var(--t-accent)] sm:text-[2.15rem]',
            })}
          />
        </>
      ) : (
