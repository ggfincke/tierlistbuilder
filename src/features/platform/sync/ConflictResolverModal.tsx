// src/features/platform/sync/ConflictResolverModal.tsx
// blocking modal that surfaces unresolved sync conflicts. opens for the
// head of useConflictQueueStore; resolving an entry dequeues & exposes
// the next conflict (if any). cannot be dismissed w/o picking an action,
// to avoid the user editing on top of stale-cloud state w/o noticing
