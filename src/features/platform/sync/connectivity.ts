// src/features/platform/sync/connectivity.ts
// browser online/offline detection. installs window listeners, mirrors
// navigator.onLine into the syncStatusStore, & invokes onOnline when the
// browser transitions from offline -> online so the consumer can re-queue
// any boards w/ a pendingSyncAt marker
