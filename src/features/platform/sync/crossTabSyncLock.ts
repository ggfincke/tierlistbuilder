// src/features/platform/sync/crossTabSyncLock.ts
// BroadcastChannel-based cross-tab coordination for cloud sync.
// two tabs on the same origin can race pushing the same board;
// this module lets a tab claim a short TTL lock & peer tabs skip flushes
// for boards that were recently claimed elsewhere
