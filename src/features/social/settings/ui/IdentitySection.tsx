// src/features/social/settings/ui/IdentitySection.tsx
// identity profile editor backed by the page-level profile draft
...
export const IdentitySection = ({ profile }: IdentitySectionProps) =>
{
  ...
  // todo(schema): add given/family/website fields before restoring those inputs.
  return (
    <SetSection
      eyebrow="Public"
      title="Identity"
