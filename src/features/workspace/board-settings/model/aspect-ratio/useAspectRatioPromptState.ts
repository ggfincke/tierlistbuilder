// src/features/workspace/board-settings/model/aspect-ratio/useAspectRatioPromptState.ts
...
import { useAutoCropController } from '~/features/workspace/board-settings/model/auto-crop/useAutoCropController'
