// src/features/workspace/board-settings/model/useImageImport.ts
// shared image upload logic: drag state, file processing, & error feedback

import { useCallback, useRef, useState } from 'react'

import { useActiveBoardStore } from '~/features/workspace/boards/model/useActiveBoardStore'
import { processImageFiles } from '~/features/workspace/board-settings/lib/imageResize'
...
export const useImageImport = (): UseImageImportReturn =>
{
  ...
  // Process files: filter, resize, & dispatch to store.
