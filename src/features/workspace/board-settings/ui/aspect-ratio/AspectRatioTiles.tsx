// src/features/workspace/board-settings/ui/aspect-ratio/AspectRatioTiles.tsx
...
import { fitRectInBox } from '~/features/workspace/board-settings/ui/aspect-ratio/aspectRatioPreviewRect'
...
interface RatioTileProps
{
  ...
  // Auto tile ratio preview, derived from current items when available.
  autoRatio?: number
}

// Preset/auto tile w/ rectangle preview drawn at the option ratio.
const RatioTile = ({
  option,
  isActive,
  onSelect,
...
// Custom tile w/ live-preview rect, inline editor, & apply action.
const CustomTile = ({
  isActive,
  width,
  height,
