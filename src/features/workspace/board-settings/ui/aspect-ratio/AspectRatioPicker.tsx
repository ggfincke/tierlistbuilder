// src/features/workspace/board-settings/ui/aspect-ratio/AspectRatioPicker.tsx
...
interface AspectRatioChipsProps
{
  ...
  autoRatio?: number
  // Custom chips surface the resolved board ratio as a suffix.
  // This shows the typed value w/o opening the inputs.
  customRatioValue?: number
  // Optional alignment override: modal left-aligns, section right-aligns.
