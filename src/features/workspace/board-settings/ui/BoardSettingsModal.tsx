// src/features/workspace/board-settings/ui/BoardSettingsModal.tsx
// tabbed board-settings modal orchestration
...
import { AppearanceTab } from '~/features/workspace/board-settings/ui/AppearanceTab'
import { ItemsTab } from '~/features/workspace/board-settings/ui/ItemsTab'
import { LayoutTab } from '~/features/workspace/board-settings/ui/LayoutTab'
import { MoreTab } from '~/features/workspace/board-settings/ui/MoreTab'
...
}: BoardSettingsModalProps) =>
{
  ...
  // Keep draft text-item color aligned until the user customizes it.
  useEffect(() =>
  {
  ...
  // Compute storage usage only when the More tab is visible.
  // useMemo avoids an effect & repeated localStorage scans.
