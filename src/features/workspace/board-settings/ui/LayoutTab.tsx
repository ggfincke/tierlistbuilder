// src/features/workspace/board-settings/ui/LayoutTab.tsx
...
import { AspectRatioSection } from '~/features/workspace/board-settings/ui/aspect-ratio/AspectRatioSection'
...
export const LayoutTab = () =>
{
  ...
  // Re-pin the active board override so captions update right away.
  // Template imports bake fontSizePx into boardLabels & shadow the global.
