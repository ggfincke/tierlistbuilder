// src/features/workspace/image-editor/lib/imageEditorTransformOps.ts
...
import { normalizeRotation } from '~/features/workspace/image-editor/lib/imageEditorGeometry'
