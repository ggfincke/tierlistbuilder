// src/features/workspace/image-editor/ui/ImageEditorPreviewCanvas.tsx
...
interface ImageEditorPreviewCanvasProps
{
  ...
  // Plate inset floats the image so the backdrop shows in the margin.
  // This matches the live board's FramedItemMedia render.
  padding: number
  isDragging: boolean
