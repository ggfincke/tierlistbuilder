// src/features/workspace/image-editor/ui/ImageEditorPane.tsx
...
import type { ImageEditorMode } from '~/features/workspace/image-editor/model/useImageEditorStore'
import { useArrowKeyNudge } from '~/features/workspace/image-editor/model/transform/useArrowKeyNudge'
import { useImageEditorAutoCropItem } from '~/features/workspace/image-editor/model/auto-crop/useImageEditorAutoCropItem'
import { useImageEditorPaddingDraft } from '~/features/workspace/image-editor/model/transform/useImageEditorPaddingDraft'
import { useImageEditorTransformDraft } from '~/features/workspace/image-editor/model/transform/useImageEditorTransformDraft'
import { usePanGesture } from '~/features/workspace/image-editor/model/transform/usePanGesture'
import { usePaneLabelEditor } from '~/features/workspace/image-editor/model/labels/usePaneLabelEditor'
import { useWheelZoom } from '~/features/workspace/image-editor/model/transform/useWheelZoom'
import {
  ImageEditorMetadataPanel,
  type ImageEditorMetadataPanelHandle,
} from '~/features/workspace/image-editor/ui/ImageEditorMetadataPanel'
import { ImageEditorPaneFooter } from '~/features/workspace/image-editor/ui/ImageEditorPaneFooter'
import { ImageEditorPaneHeader } from '~/features/workspace/image-editor/ui/ImageEditorPaneHeader'
import { ImageEditorPreviewCanvas } from '~/features/workspace/image-editor/ui/ImageEditorPreviewCanvas'
import { LabelEditorRow } from '~/features/workspace/image-editor/ui/LabelEditorRow'
...
)
{
  ...
  // Gesture deltas normalize by the padding-inset image frame.
  // This keeps pan/nudge 1:1 w/ the cursor at any padding.
