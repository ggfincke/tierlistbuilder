// src/features/workspace/comparison/ui/ComparisonModal.tsx
...
import {
  computeBoardDiff,
  type BoardDiff,
} from '@/features/workspace/comparison/model/boardDiff'
import { useComparisonMode } from '@/features/workspace/comparison/model/useComparisonMode'
...
const buildDiffHighlights = (
  diff: BoardDiff,
  leftData: BoardSnapshot,
  rightData: BoardSnapshot
